class ChartHelper {
    public static transformData(response:IHabitResponse, minDate:Date, maxDate:Date) : IChartData[] {
        
        let returnValue:IChartData[] = []
        ...
        response.value.forEach( (habit : IHabit) => {
            const day = habit.viewDate.getDate(),
                  month = habit.viewDate.getMonth(),
                  year = habit.viewDate.getFullYear()
